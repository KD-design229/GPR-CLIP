...
class ClientBase(object):
    ...
    def __init__(self, args, id, modelObj, train_set, test_set, **kwargs):
        ...
        self.args = args  # Store the full args for FedVLS/FedDecorr access
        ...
        # [GPR-FedSense] Store related attributes
        self.num_classes = getattr(args, 'num_classes', 10)
        self.use_fedvls = getattr(args, 'use_fedvls', False)
        self.fedvls_alpha = getattr(args, 'fedvls_alpha', 1.0)
        self.use_feddecorr = getattr(args, 'use_feddecorr', False)
        self.feddecorr_beta = getattr(args, 'feddecorr_beta', 0.1)
